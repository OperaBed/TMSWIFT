void print_input(PetscErrorCode ierr, params *params)
{
	...
	ierr = PetscPrintf(PETSC_COMM_WORLD,"%d %d %g %d %d %d %d",params->nf,params->Jz,params->alpha,params->flag_anni,params->flag_mix,params->flag_asy,params->flag_mumps);CHKERRV(ierr);
